...
export default function Auth() {
  ...
  // Google and GitHub always send the visitor back to /dashboard. When they were
  // on their way somewhere else, remember it so ProtectedRoute can finish the trip.
  const oauthSignIn = (provider: "google" | "github") => {
    if (searchParams.get("redirect")) rememberReturnTo(redirectTo);
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold font-display">Welcome to {BRAND.name}</h1>
