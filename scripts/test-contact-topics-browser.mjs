...
try{
 ...
 await row().getByRole('button',{name:'Discussed today',exact:true}).click();
 ...
 await row().getByRole('button',{name:'Edit',exact:true}).click();await row().getByRole('textbox',{name:'Edit topic title'}).fill(edited);await row().getByRole('button',{name:'Save',exact:true}).click();
 ...
 await page.getByRole('listitem',{name:edited,exact:true}).getByRole('button',{name:'History',exact:true}).click();
 ...
 await page.getByRole('button',{name:/^Discussed\s+\d+$/}).click();
 await page.getByRole('listitem',{name:edited,exact:true}).waitFor();
 await page.getByRole('listitem',{name:edited,exact:true}).getByRole('button',{name:'Reopen',exact:true}).click();
 await page.getByRole('button',{name:/^To discuss\s/}).click();
 await page.getByRole('listitem',{name:edited,exact:true}).getByRole('button',{name:'Archive',exact:true}).click();
 await page.getByRole('button',{name:/^Archived\s/}).click();await page.getByRole('listitem',{name:edited,exact:true}).waitFor();
 await page.getByRole('button',{name:'Undo last change',exact:true}).click();await page.getByRole('button',{name:/^To discuss\s/}).click();
 await page.getByRole('listitem',{name:edited,exact:true}).waitFor();
