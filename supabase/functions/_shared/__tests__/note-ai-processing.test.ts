...
it.each([{ai_visibility:'hidden'},{source_app:'godspeed'}])('indexes restricted snapshots without derivative reads or writes: %j',async(restriction)=>{
